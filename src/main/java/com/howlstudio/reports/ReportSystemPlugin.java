...
/** ReportSystem — Players report griefers/rule-breakers. Reports logged to file, viewable by admins. */
public final class ReportSystemPlugin extends JavaPlugin {
    ...
    @Override protected void setup(){
        ...
        System.out.println("[Reports] Ready. "+mgr.getCount()+" open reports.");
    }
